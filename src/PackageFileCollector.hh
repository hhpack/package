...
final class PackageFileCollector implements FileCollector<DirectoryPath, PackageFileVector>
{

    public function collectFrom(DirectoryPath $target) : PackageFileVector
    {
        $packageFiles = Vector {};
    ...
    private function findFiles(string $target) : Generator<int, PackageFile, void>
    {
